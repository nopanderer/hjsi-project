...
public class TowerView extends RelativeLayout
{
    ...
    private void designInnerLayout()
    {
        ...
        LayoutParams lpName = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
        LayoutParams lpDmg = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
        LayoutParams lpRate = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private void updateText()
    {
        ...
        mDmg.setText("DMG: " + String.valueOf(mElement.damage));
        mRate.setText("RATE: " + String.valueOf(mElement.attackSpeed));
    }
