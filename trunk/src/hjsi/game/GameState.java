...
public class GameState {
	...
	private GameState() {
		...
		/*
		 * 불러온 유저 데이터를 토대로 동상을 생성한다. (유저 데이터의 남아있는 동상의 갯수, 체력, 업그레이드 등을 참조) 생성한
		 * 동상은 유닛 목록에 추가한다.
		 */
		arTestUnits.add(new Statue(180, 120, AppManager.getInstance()
				.getBitmap("statue")));
	}
	...
	public void makeFace() {
		...
		int drawableId = res.getIdentifier("mob" + wave, "drawable",
				"exam.androidproject");
